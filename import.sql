...
-- Erstellungszeit: 02. Dez 2025 um 12:43
...
--
-- Standarddaten fuer Tabelle `products`
--
...
--
-- Tabellenstruktur fuer Tabelle `credit_packages`
--
...
--
-- Standarddaten fuer Tabelle `credit_packages`
--
...
CREATE TABLE `status_logs_new` (
  ...
  `source` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'n8n',
...
--
-- Indizes fuer die Tabelle `credit_packages`
--
ALTER TABLE `credit_packages`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_credit_packages_key` (`package_key`),
  ADD KEY `idx_credit_packages_active` (`active`);
...
--
-- AUTO_INCREMENT fuer Tabelle `credit_packages`
--
ALTER TABLE `credit_packages`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;
